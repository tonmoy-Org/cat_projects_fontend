...
export const PublicLayout = ({ children, title, description }) => {
    ...
    const navItems = [
        ...
        { label: 'Product', path: '/product', icon: <ShoppingBagIcon fontSize="small" /> },
        { label: 'Blog', path: '/blog', icon: <ArticleIcon fontSize="small" /> },
        { label: 'Video', path: '/video', icon: <VideoLibraryIcon fontSize="small" /> },
    ...
    const userMenuItems = [
        ...
        { label: 'Logout', action: handleLogout, icon: <LogoutIcon fontSize="small" /> },
    ];
                                ...
                                <Box sx={{
                                    ...
                                    {navItems.map((item) => (
                                        <Button
                                            ...
                                            sx={{
                                                color: isActive(item.path) ? ACTIVE_COLOR : theme.palette.text.primary,
                                                fontSize: '0.9rem',
                                            ...
                                            {userMenuItems.map((item) => (
                                                <MenuItem
                                                    ...
                                                    sx={{
                                                        ...
                                                        ...(item.label !== 'Logout' && isActive(item.path) && {
                                                            color: ACTIVE_COLOR,
                                                            backgroundColor: LIGHT_BG,
                                                        }),
                                                    }}
                                                >
                                                    <Box sx={{ color: item.label === 'Logout' ? 'inherit' : ACTIVE_COLOR }}>
                                                        {item.icon}
                                                    </Box>
                                                    <ListItemText
                                                        primary={item.label}
                    ...
                    <List sx={{ py: 0 }}>
                        {navItems.map((item) => (
                            <ListItem key={item.label} disablePadding sx={{ mb: 0.5 }}>
                                ...
                                >
                                    <Box sx={{ color: isActive(item.path) ? ACTIVE_COLOR : 'inherit' }}>
                                        {item.icon}
                                    </Box>
                                    <ListItemText
                                        primary={item.label}
            ...
            >
                <Container maxWidth="lg">
                    ...
                    >
                        ...
                        <Box component="span" sx={{ mx: 1, color: alpha(ACTIVE_COLOR, 0.5) }}>•</Box>
