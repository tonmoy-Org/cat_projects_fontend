...
const ReviewCount = styled(Typography)({ fontSize: '14px', color: darkGray });
...
const FeatureList = styled(Box)({ marginBottom: '30px' });
...
const ProductDetail = () => {
  ...
  // Fetch all products for related section (large limit to get random 4)
    ...
    <Box>
      ...
      <ProductDetailSection>
        <Container maxWidth="lg">
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <ProductInfoWrapper>
                ...
                <RatingWrapper>
                  ...
                  />
                  <ReviewCount>Be the first to review</ReviewCount>
                </RatingWrapper>
                ...
                <AddToCartWrapper>
                  <QuantityInput
                    ...
                    size="small"
                  />
                  <AddToCartButton variant="contained" disabled={!product.inStock}>
          ...
          <TabsWrapper>
            <TabHeaders>
              <TabHeader active={activeTab === 'features' ? 1 : 0} onClick={() => setActiveTab('features')}>
                Features
              </TabHeader>
              <TabHeader active={activeTab === 'reviews' ? 1 : 0} onClick={() => setActiveTab('reviews')}>
                Reviews
              </TabHeader>
            </TabHeaders>
            ...
            <TabContent>
              {activeTab === 'features' && (
                <Box>
                  ...
                  <FeaturesList>
                    {product.category && (
                      <li><FavoriteIcon />Category: {product.category}</li>
                    )}
                    {product.material && (
                      <li><FavoriteIcon />Material: {product.material}</li>
                    )}
              ...
              {activeTab === 'reviews' && (
                <ReviewsWrapper>
                  <Typography sx={{ color: darkGray, mb: 3 }}>
                    No reviews yet. Be the first to leave a review!
                  </Typography>

                  <ReviewFormWrapper>
                    <FormTitle>Add a review</FormTitle>
                    <StyledRating sx={{ mb: 2 }} name="rating" defaultValue={0} size="large" />
                    <StyledTextField fullWidth placeholder="Name*" required size="small" />
                    <StyledTextField fullWidth placeholder="Email*" type="email" required size="small" />
                    <StyledTextField fullWidth placeholder="Your Review*" multiline rows={4} required />
