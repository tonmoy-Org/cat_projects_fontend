...
const galleryImages = [
  {
    id: 1,
    image: 'https://images.unsplash.com/photo-1543852786-1cf6624b9987?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1587&q=80',
    category: 'Cat',
  },
  {
    id: 2,
    image: 'https://images.unsplash.com/photo-1583511655826-05700d52f4d9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1588&q=80',
    category: 'Dog',
  },
  {
    id: 3,
    image: 'https://images.unsplash.com/photo-1574231164645-d6f0e8553590?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1586&q=80',
    category: 'Rabbit',
  },
  {
    id: 4,
    image: 'https://images.unsplash.com/photo-1534351450181-ea9f78427fe8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1587&q=80',
    category: 'Bird',
  },
];
...
const About = () => {
  return (
    <Box>
      {/* Hero Section - Now a reusable component */}
      <HeroServiceSection />
          ...
          <Grid container spacing={3}>
            {galleryImages.map((item) => (
              <Grid size={{ xs: 12, sm: 6, md: 3 }} key={item.id}>
                <GalleryCard>
                  <GalleryImage src={item.image} alt={`Pet gallery ${item.id}`} />
